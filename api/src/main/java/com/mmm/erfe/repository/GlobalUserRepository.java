...
public interface GlobalUserRepository extends JpaRepository<GlobalUser, String> {
	...
	public List<GlobalUser> find(@Param("personId") String personId, @Param("userPin")String userPin,@Param("firstName")String firstName,@Param("lastName") String lastName);
