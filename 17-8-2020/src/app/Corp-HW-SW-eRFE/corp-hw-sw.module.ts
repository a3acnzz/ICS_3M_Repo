...
import { CalendarModule, CheckboxModule, EditorModule, RadioButtonModule, ToggleButtonModule, CardModule, ButtonModule, DialogModule, DropdownModule, FileUploadModule } from 'primeng/primeng';
...
@NgModule({
  ...
  imports: [
    ...
    FileUploadModule,
    AutoCompleteModule,
    // CalendarModule, CheckboxModule, EditorModule, ToggleButtonModule,
