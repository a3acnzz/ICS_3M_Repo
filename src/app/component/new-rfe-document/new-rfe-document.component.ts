 ...
 */
    ...
    */
    ...
    checkFormValidation(form): boolean {
        ...
        } else if (!distributionCheck || this.approvalAmount === 0 || this.approverLimitValid || this.validateAccountingTable.accountInValid || this.validateAccountingTable.costCenterInValid) {
