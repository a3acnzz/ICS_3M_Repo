...
export class DashboardComponent implements OnInit {
   ...
   * @param cookieService 
   */
  constructor(private deviceService: DeviceDetectorService, public showHeaderFlagService: ShowHeaderService, private cookieService: CookieService, private router: Router,
