...
export class PrintRfeFormComponent implements OnInit, AfterViewInit {
  ...
  */
  ...
  /**
   * Automatic Click from ts
   */
  @ViewChild('printButtonInBottom', { static: false }) printButtonInBottom: ElementRef;
  @ViewChild('printrfeForm', { static: false }) printrfeForm: ElementRef;

  ngAfterViewInit() {

    // console.log(this.printButtonInBottom.nativeElement);
    // this.printButtonInBottom.nativeElement.click();
    // // below 2 sometimes gives blank page
    // this.printButtonInBottom.nativeElement.trigger('click');
    // setTimeout(() => { this.printButtonInBottom.nativeElement.trigger('click'); }, 10000);

    // console.log(this.printrfeForm.nativeElement);
    // this.printrfeForm.nativeElement.click();
    // this.printrfeForm.nativeElement.trigger('click');
    // setTimeout(() => { this.printrfeForm.nativeElement.click() }, 10000);
