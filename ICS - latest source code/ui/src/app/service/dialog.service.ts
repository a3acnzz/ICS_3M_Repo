...
export class DialogService {
  ...
  public selectProgramDate(programId: number, timeSlotId: number, programDateId: number,isrecursivePrg: boolean) {
    ...
    dialogRef.componentInstance.isRecursive=isrecursivePrg;
    return dialogRef.afterClosed();
  }
  ...
  public emailTemplates(locationId: number, programId: number, locationName: String, programName: String) {
    ...
    //dialogRef.componentInstance.mandatoryMessage=message;
  }
  ...
  public appointmentCancellation(appointmentId: number,recursive: boolean,cancelappointmentList:any[]) {
    ...
    dialogRef.componentInstance.isRecursive=recursive;
    dialogRef.componentInstance.cancelappointments=cancelappointmentList;
  ...
  //recursive single timeslot

  public recursivesingleTimeSlot( minAppointmentsPerUser: number, maxAppointmentsPerUser: number) {

    let dialogRef: MatDialogRef<SingleTimeSlotDialogComponent>;

    dialogRef = this.dialog.open(SingleTimeSlotDialogComponent);

    dialogRef.componentInstance.recursiveSingle = true;
    dialogRef.componentInstance.minAppointmentsPerUser = minAppointmentsPerUser;
    dialogRef.componentInstance.maxAppointmentsPerUser = maxAppointmentsPerUser;

    return dialogRef.afterClosed();
  }
  public recursivemultipleTimeSlot(minAppointmentsPerUser: number, maxAppointmentsPerUser: number) {
    ...
    //dialogRef.componentInstance.programDate = submittedProgramDate.substr(0, 10);
    dialogRef.componentInstance.recursiveMultiple=true;
    dialogRef.componentInstance.minAppointmentsPerUser = minAppointmentsPerUser;
    dialogRef.componentInstance.maxAppointmentsPerUser = maxAppointmentsPerUser;

    return dialogRef.afterClosed();
  }
  public recursivechangeMaxAppointments( timeSlotId: number, existingMaxAppointments: number) {
