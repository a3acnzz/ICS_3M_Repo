...
describe('Location BCC emails', () => {
  ...
  beforeAll(function () {
    http.get('http://localhost:8080/E2E/prepareLocationBccEmails');
  });
  //
  // beforeEach(() => {
  // });
  ...
  it('Test Validation Messages', () => {
    ...
    e2eHelpers.getElementText('dialogTitle').then(function(value) {
      expect(value).toContain(bccEmailData.locationDialogTitle);
    });
