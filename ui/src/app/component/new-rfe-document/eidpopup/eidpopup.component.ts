 ...
 */
  ...
  */
  ...
  populateNames(lastName: string, firstName: string) {
    this.selectForm.controls['lastName'].setValue(lastName);
    this.selectForm.controls['firstName'].setValue(firstName);
    this.searchForm();
  }

  populateSupplierName(supplierName: string) {
    this.orderForm.controls['name'].setValue(supplierName);
    this.orderSearch();
  }
